...
[](https://github.com/Prathibha2416/IMAGES-FOR-REFERENCE-/blob/main/JOINS-INNER%20JOIN%20RESULT-HR.png)
...
SELECT E.F_NAME, E.L_NAME, E.DEP_ID, H.START_DATE, J.JOB_TITLE 

FROM EMPLOYEES AS E 

INNER JOIN JOB_HISTORY AS H ON E.EMP_ID = H.EMPL_ID
